...
Ethan orchestrator agent.

## What This Demonstrates

- **Channel integration** — connecting Ethan to messaging platforms (Slack, WhatsApp, etc.)
...
- Python 3.10+
- Ethan installed: `uv sync --extra dev`
...
2. Configure the WhatsApp Baileys bridge (see the Ethan channel docs).
...
Ethan supports many channels — LINE, Viber, Mastodon, Rocket.Chat, and
