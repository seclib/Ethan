...
class TestScoreBatch:
    ...
    def test_higher_accuracy_ranks_above_lower_at_equal_efficiency(self) -> None:
        a = TrainingSample(accuracy=1.0, energy_joules=200, latency_seconds=5, cost_usd=0.0)
        b = TrainingSample(accuracy=0.0, energy_joules=200, latency_seconds=5, cost_usd=0.0)
    ...
    def test_lower_efficiency_costs_lower_reward_at_equal_accuracy(self) -> None:
        ...
        # gets penalized.
        fast = TrainingSample(accuracy=1.0, energy_joules=100, latency_seconds=2, cost_usd=0.0)
        slow = TrainingSample(accuracy=1.0, energy_joules=400, latency_seconds=8, cost_usd=0.0)
    ...
    def test_custom_weights_change_ranking(self) -> None:
        ...
        a = TrainingSample(accuracy=1.0, energy_joules=999, latency_seconds=99, cost_usd=99)
    ...
    def test_zero_variance_batch_drops_efficiency_terms(self) -> None:
        ...
        samples = [
            TrainingSample(accuracy=1.0, energy_joules=100, latency_seconds=2, cost_usd=0.0),
            TrainingSample(accuracy=0.5, energy_joules=100, latency_seconds=2, cost_usd=0.0),
        ]
