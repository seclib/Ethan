...
class TestMemoryStore:
    ...
    def test_record_stores_entry(self) -> None:
        from cli.core.memory import MEM_FILE, record
    ...
    def test_record_truncates_long_text(self) -> None:
        from cli.core.memory import MAX_TEXT, record
    ...
    def test_recent_ordering(self) -> None:
        from cli.core.memory import recent, record
    ...
    def test_frequent_counts(self) -> None:
        from cli.core.memory import frequent, record
...
class TestSessions:
    ...
    def test_new_session_saves_to_file(self) -> None:
        from cli.core.memory import SESSION_FILE, new_session
    ...
    def test_resume_existing_session(self) -> None:
        from cli.core.memory import new_session, resume_session
    ...
    def test_get_history(self) -> None:
        from cli.core.memory import get_history, record
...
class TestSessionInfo:
    ...
    def test_get_session_info(self) -> None:
        from cli.core.memory import get_session_info, record
    ...
    def test_get_context_usage(self) -> None:
        from cli.core.memory import get_context_usage, record
    ...
    def test_reset_context(self) -> None:
        from cli.core.memory import get_history, record, reset_context
...
class TestMaxEntries:
    ...
    def test_max_entries(self) -> None:
        from cli.core.memory import MAX_ENTRIES, recent, record
