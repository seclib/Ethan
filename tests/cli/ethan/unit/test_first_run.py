...
class TestFirstRun:
    ...
    def test_is_first_run_true(self) -> None:
        from cli.core.first_run import is_first_run

        # Marker does not exist
        assert is_first_run() is True

    def test_is_first_run_false(self) -> None:
        from cli.core.first_run import is_first_run, mark_installed

        mark_installed()
        assert is_first_run() is False

    def test_mark_installed_creates_marker(self) -> None:
        from cli.core.first_run import FIRST_RUN_MARKER, mark_installed
...
class TestMaybeShowFirstRun:
    ...
    def test_maybe_show_first_run_shows_welcome(self, capsys) -> None:
        from cli.core.first_run import FIRST_RUN_MARKER, maybe_show_first_run
    ...
    def test_maybe_show_first_run_not_shown_again(self, capsys) -> None:
        from cli.core.first_run import mark_installed, maybe_show_first_run
