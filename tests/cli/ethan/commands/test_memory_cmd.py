...
class TestMemoryCmd:
    ...
    def test_memory_default_shows_recent(self, capsys) -> None:
        ...
        with mock.patch("cli.commands.memory.mem.recent", return_value=[{"text": "recent entry"}]):
            result = cmd_memory([])
    ...
    def test_memory_recent_subcommand(self, capsys) -> None:
        ...
        with mock.patch(
            "cli.commands.memory.mem.recent",
            return_value=[{"text": "entry 1"}, {"text": "entry 2"}],
        ):
    ...
    def test_memory_recent_with_count(self, capsys) -> None:
        ...
        with mock.patch("cli.commands.memory.mem.recent", return_value=[{"text": "only one"}]):
    ...
    def test_memory_frequent(self, capsys) -> None:
        ...
        with mock.patch(
            "cli.commands.memory.mem.frequent", return_value=[{"text": "frequent cmd", "count": 5}]
        ):
    ...
    def test_memory_frequent_with_count(self, capsys) -> None:
        ...
        with mock.patch(
            "cli.commands.memory.mem.frequent", return_value=[{"text": "top cmd", "count": 10}]
        ):
