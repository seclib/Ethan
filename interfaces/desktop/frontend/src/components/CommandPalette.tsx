...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'ethan-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'ethan-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to Ethan servers</span>
          )}
        </div>
      </div>
    </div>
