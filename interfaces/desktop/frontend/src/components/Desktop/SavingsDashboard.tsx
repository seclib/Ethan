...
const OPTIN_KEY = 'ethan-desktop-optin';
const OPTIN_NAME_KEY = 'ethan-desktop-display-name';
const OPTIN_EMAIL_KEY = 'ethan-desktop-email';
const OPTIN_ANONID_KEY = 'ethan-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://open-jarvis.github.io/Ethan/leaderboard"
            target="_blank"
