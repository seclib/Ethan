...
const GITHUB_BASE =
  'https://github.com/open-jarvis/Ethan/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/open-jarvis/Ethan.git\ncd Ethan\nuv sync"} />
