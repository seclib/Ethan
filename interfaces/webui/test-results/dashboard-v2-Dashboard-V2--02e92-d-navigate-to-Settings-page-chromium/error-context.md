...
- Name: dashboard-v2.spec.ts >> Dashboard V2 — Navigation & Pages >> should navigate to Settings page
- Location: tests/e2e/dashboard-v2.spec.ts:40:7
