...
- Name: dashboard-v2.spec.ts >> Dashboard V2 — Navigation & Pages >> should navigate to Missions page
- Location: tests/e2e/dashboard-v2.spec.ts:10:7
