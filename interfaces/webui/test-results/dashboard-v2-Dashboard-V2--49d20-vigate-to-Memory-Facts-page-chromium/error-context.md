...
- Name: dashboard-v2.spec.ts >> Dashboard V2 — Navigation & Pages >> should navigate to Memory Facts page
- Location: tests/e2e/dashboard-v2.spec.ts:22:7
...
Locator: locator('h1')
Expected substring: "Memory Facts"
