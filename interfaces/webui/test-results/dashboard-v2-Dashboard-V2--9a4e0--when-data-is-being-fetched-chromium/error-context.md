...
- Name: dashboard-v2.spec.ts >> Dashboard V2 — Navigation & Pages >> should show loading state when data is being fetched
- Location: tests/e2e/dashboard-v2.spec.ts:73:7
...
Locator: locator('text=Loading agents...')
Expected: visible
Timeout: 500ms
...
Call log:
  ...
  - waiting for locator('text=Loading agents...')
