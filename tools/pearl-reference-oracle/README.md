# Pearl reference oracle (Ethan Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the Ethan `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `Ethan/src/openjarvis/mining/_constants.py`.
