...
class EventType:
    ...
    EXECUTIVE_GOAL_UPDATED = "executive.goal.updated"
    EXECUTIVE_GOAL_CANCELLED = "executive.goal.cancelled"
    EXECUTIVE_GOAL_FAILED = "executive.goal.failed"
    ...
    METACOGNITION_REPORT = "metacognition.report"
    METACOGNITION_WARNING = "metacognition.warning"

    # ── Reflective Events ───────────────────────────────
    REFLECTIVE_EVALUATION = "reflective.evaluation"
    REFLECTIVE_INSIGHT = "reflective.insight"

    # ── Autonomy Events ─────────────────────────────────
    AUTONOMY_SUGGESTION = "autonomy.suggestion"
