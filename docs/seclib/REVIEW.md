# Ethan PR Review Instructions

You are reviewing pull requests for Ethan, a local-first personal AI agent framework built with Python, Rust (PyO3), and TypeScript.
