...
All notable changes to Ethan are documented in this file.
...
`https://ethan.github.io/Ethan/install.sh`, generated from
...
**`jarvis self-update`** subcommand. Detects how Ethan was
...
- **Editable-git users running `jarvis self-update`** get the
  ...
  checkout, not `~/Ethan`. If you'd come to rely on the
...
Companion blog post:
[From Minions to Ethan: A Retrospective on Two Years in Local AI](https://hazyresearch.stanford.edu/blog/2026-05-19-minions-to-openjarvis-retrospective).
