...
- Python 3.10 – 3.13 (Python 3.14 has no numpy Windows wheels yet —
  see [#432](https://github.com/open-jarvis/Ethan/issues/432)).
- `git` on PATH.
...
```powershell
irm https://open-jarvis.github.io/Ethan/install.ps1 | iex
```
...
4. Install `uv` if absent (via the official `astral.sh/uv` PowerShell
   installer).
5. Clone the repo to `%LOCALAPPDATA%\Ethan\src`.
...
See [`deploy/windows/README.md`](https://github.com/open-jarvis/Ethan/blob/main/deploy/windows/README.md)
