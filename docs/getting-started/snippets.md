---
title: Code Snippets
description: Copy-paste patterns for common Ethan tasks
---

# Code Snippets

Ready-to-use patterns for the most common Ethan tasks. Each snippet is self-contained and copy-pasteable.
...
```bash
docker build -t ethan .
docker run -p 8000:8000 ethan serve --host 0.0.0.0
```
