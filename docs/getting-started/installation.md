---
title: Installation
description: Get Ethan running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
Ethan runs entirely on your hardware. Choose the interface that fits your workflow.
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/ethan-python/Cargo.toml
...
The desktop app is a native window for the Ethan chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **Ethan.dmg**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **Ethan-setup.exe**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **Ethan.deb**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **Ethan.rpm**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **Ethan.AppImage**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/Ethan.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/open-jarvis/Ethan/releases) page.
...
The command-line interface is the fastest way to interact with Ethan
...
```python
from ethan import SystemBuilder
...
Ethan uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — Ethan communicates over HTTP. You still need the engine software running on your machine.
...
Ethan requires at least one inference backend. Choose the one that matches your hardware.
