...
Ethan on Windows installs two ways: **WSL2** (this page — the
...
- Models are stored in WSL's filesystem (`~/.ethan/`), not your Windows drive. To free up space later: `jarvis-uninstall` removes everything.
