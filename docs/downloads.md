---
title: Downloads
description: Download the Ethan desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/open-jarvis/Ethan.git && cd Ethan
...
|----------|----------|-------|
| macOS (Universal) | [:material-download: **Ethan.dmg**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_universal.dmg) | Apple Silicon + Intel |
| Windows (64-bit) | [:material-download: **Ethan-setup.exe**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **Ethan.deb**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **Ethan.rpm**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan-1.0.1-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **Ethan.AppImage**](https://github.com/open-jarvis/Ethan/releases/download/desktop-v1.0.2/Ethan_1.0.1_amd64.AppImage) | Any distro |
...
by Apple. If you see **"Ethan is damaged and can't be opened"**, run this in
