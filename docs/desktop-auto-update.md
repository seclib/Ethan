...
The Ethan desktop app ships with [Tauri's updater
...
on launch / every 30 min
        │
        ▼
GET https://github.com/open-jarvis/Ethan/releases/download/desktop-latest/latest.json
        │
        ▼
...
curl -fsSL https://github.com/open-jarvis/Ethan/releases/download/desktop-latest/latest.json | jq .
