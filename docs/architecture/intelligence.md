...
```python
from ethan.intelligence import merge_discovered_models
...
The following names are still importable from `ethan.intelligence` via shim modules, but their canonical locations have moved:
