...
The default path is `~/.ethan/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/ethan/security/index.md) — complete class and function signatures
