...
- **Persistence:** SQLite database file (default: `~/.ethan/memory.db`)
...
```python
from ethan.tools.storage.bm25 import BM25Memory
...
!!! note "Backward compatibility"
    The old `from ethan.memory.bm25 import BM25Memory` still works via backward-compatibility shims, but new code should use the canonical `ethan.tools.storage.*` imports.
...
[Source: docs/intro.md] Ethan is a modular AI framework...
