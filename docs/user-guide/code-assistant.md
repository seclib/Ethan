...
This writes a pre-configured `~/.ethan/config.toml` for the code assistant.
...
jarvis ask "Read src/ethan/core/events.py and explain the EventBus pattern"
...
# Generate tests
jarvis ask "Read src/ethan/tools/calculator.py and write unit tests for it"
