---
title: Showcase
description: What people actually do with Ethan — outcomes first, scripts later
---

# Showcase

These are stories from people who use Ethan day to day. Each entry shows the **result** — a screenshot, a paragraph of context, and a short link to the docs that explain how to build it. If you're trying to figure out whether Ethan is worth a weekend of your time, start here.
...
The Showcase grows from real users. If you've built something interesting on top of Ethan — or just have a configuration you're proud of — the format is simple and the bar is low:
...
4. **"How I set this up →"**: a link to the relevant [Tutorial](../tutorials/index.md), [User Guide](../user-guide/cli.md), or [Recipe](https://github.com/open-jarvis/Ethan/tree/main/src/ethan/recipes/data).
...
The **`#config-showcase`** channel in the [Ethan Discord](https://discord.gg/ethan) is where people post and discuss personal setups. Drop a screenshot, ask "how would I do X?", or browse what others have shared.
