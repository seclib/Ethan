...
description: How to add your setup to the Ethan Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether Ethan is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/open-jarvis/Ethan/tree/main/src/ethan/recipes/data)** if you want the exact config.
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the Ethan Discord](https://discord.gg/ethan). You'll get tagged in the post — you don't have to do it yourself.
